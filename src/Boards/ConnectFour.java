...
public class ConnectFour extends Board{
	...
	/**
	 * The main class for the connect four
	 ...
	 */
	 // Named-constants for the dimensions
	   ...
	   public ConnectFour() {
	      ...
	      initGame();
	      // Play the game once. Players RED and YELLOW move alternately.
	      do {
	         ...
	         if (currentState == GamePhase.RED_WON) {
		            System.out.println("    ___   _  _  _ ___   ___  _   _ _________        \r\n" + 
		            		...
		            		"                  | |   \\_/_/   \\_| \\_/| |                        \r\n" + 
		            		"                   \\_\\                /_/      ");
		         } else if (currentState == GamePhase.YELLOW_WON) {
		            System.out.println("    ___   _  _  _ ___   ___  _   _ _________          \r\n" + 
		            		"   |  _ \\ / _ \\ |  \\/  ||  ___| |  _  || | | |  ___| __ \\         \r\n" + 
		            		"   | |  \\// /_\\ \\| .  . || |__   | | | || | | | |__ | |_/ /         \r\n" + 
		            		"   | | __ |  _  || |\\/| ||  __|  | | | || | | |  __||    /          \r\n" + 
	   ...
	   public void initGame() {
	      ...
	      currentPlayer = Piece.RED;       // RED plays first
	   ...
	   public void playerMove(Piece thePiece) {
	      ...
	      do {
	         if (thePiece == Piece.RED) {
	            System.out.print("Player 'R', enter your move (row[1-6] column[1-7]): ");
	         } else {
	            System.out.print("Player 'Y', enter your move (row[1-6] column[1-7]): ");
	         }
	   ...
	   public void updateGame(Piece thePiece) {
	      if (hasWon(thePiece)) {  // check for win
	         currentState = (thePiece == Piece.RED) ? GamePhase.RED_WON : GamePhase.YELLOW_WON;
